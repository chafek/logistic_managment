 ...
 */
final class Version20220221095012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE my_login ADD created_at DATETIME DEFAULT NULL, ADD update_at DATETIME DEFAULT NULL, DROP member_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE my_login ADD member_id INT NOT NULL, DROP created_at, DROP update_at');
